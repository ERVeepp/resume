...
| `项目经历.md` | 12 个项目，分项目描述 + 项目业绩（含 ad-tech-labs：竞价引擎 + 投放 Agent 全链路两阶段合并） |
| `项目经历精简版.md` | 12 个项目精简版（投简历用，每个项目压缩为「角色 + 要点 + 关键业绩」） |
...
- **AI Agent 全栈**：多 Agent 协作平台 + **文档/代码/多模态三 RAG**（Qdrant 向量检索 + tree-sitter 代码索引 + CLIP 图文检索 + PaddleOCR 素材合规巡检）+ SSE 流式 + Function Calling，agent-core 核心库 + VS Code 插件（已上架）
